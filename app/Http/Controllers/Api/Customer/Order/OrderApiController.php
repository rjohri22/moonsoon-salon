...
use App\Http\Resources\Api\Customer\Order\OrderApiCollection;
use App\Http\Requests\Api\Customer\Order\UpdateOrderApiRequest;
use App\Http\Requests\Api\Customer\Order\CreateOrderApiRequest;
...
class OrderApiController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $items = $this->orderApiRepository->where('user_id',\Auth::user()->id)->get();

        return $this->sendResponse(OrderApiCollection::collection($items), '');
    }
